...
$product = page($total_num_page, $page);
$check_num_page = get_list_page_product($total_num_page);
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <?php   for ($i = 1; $i <= $num_page; $i++) {   ?>
                                <li class="page-item"><a class="page-link" href="?mod=product&controllers=index&action=list_product&page=<?php echo $i ?>"><?php echo $i ?></a></li>
                            <?php }?>
                            <li class="page-item">
